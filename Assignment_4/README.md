# Assignment 4: Cell Nuclei Separation using Watershed Segmentation
...
- Simple thresholding (0.2x max) to find foreground markers
...
```bash
python Assignment_4_main.py
```

The script will process the input image (`nucleus.png`) and save results in the `results/` folder:
